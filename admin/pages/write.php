...
?>
<form action="" method="post" class="p-4 border-2 border-solid border-black rounded-lg" enctype="multipart/form-data">
    ...
    <input type="text" name="title" id="title" class="w-full rounded-[10px] border-none" placeholder="Title">
