...
<div class="mt-[30px]">
    <div>
        <img class="w-full h-[30vw] object-cover" src="admin/upload/<?= $post->image ?>" alt="<?= $post->title ?>">
        <h1 class="md:text-[30px] md:px-16 p-4">
            <?= strtoupper($post->title) ?>
        </h1>



        <div class="w-full md:px-16 p-4">
            <?= nl2br($post->content) ?>
        </div>
...
<iframe class="md:mx-16 md:mt-[30px] md:w-[560px] h-[315px] w-full " src=" https://www.youtube.com/embed/<?= $post->videos ?>" frameborder="0" allowfullscreen></iframe>

<h4 class="mt-[30px] text-[40px] text-[#169179]">
    feedback :
</h4>
<div class="w-full  h-64 flex flex-col overflow-y-auto border-1 border-solid mt-[30px]">
